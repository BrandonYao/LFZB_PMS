...
namespace LFZB_PMS.Command
{
    public class BaseCmd
    {
        ...
        public static RoutedUICommand cmd_confirm { get; }
        public static RoutedUICommand cmd_confirm_not { get; }
        public static RoutedUICommand cmd_check { get; }
        public static RoutedUICommand cmd_check_not { get; }
        ...
        static BaseCmd()
        {
            ...
            cmd_confirm = new RoutedUICommand("确认", "cmd_confirm", typeof(BaseCmd));
            cmd_confirm_not = new RoutedUICommand("反确认", "cmd_confirm_not", typeof(BaseCmd));
            cmd_check = new RoutedUICommand("审核", "cmd_check", typeof(BaseCmd));
            cmd_check_not = new RoutedUICommand("反审核", "cmd_check_not", typeof(BaseCmd));
